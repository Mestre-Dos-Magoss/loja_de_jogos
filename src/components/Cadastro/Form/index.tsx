...
const FormCadastro = () => (
  <div>
    ...
    <Ss.FormCheckLabel>
      ...
      <S.Label>
        Concordo com os <Ss.Link>Termos de Serviço</Ss.Link> e{' '}
        <Ss.Link>Política de Privacidade</Ss.Link>
      </S.Label>
    </Ss.FormCheckLabel>
    <Ss.ButtonForm to={'/login'}>Criar conta</Ss.ButtonForm>
  </div>
)
