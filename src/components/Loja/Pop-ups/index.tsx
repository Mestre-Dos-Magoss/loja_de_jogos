...
const PopUps = ({ viewPopUp }: Props) => {
  return (
    <S.PopUpContainer viewPopUp={viewPopUp}>
      <S.PopUpImgContainer>
        <FavoritarContainer>
          <TagDesconto>- 21% off</TagDesconto>
          <S.Icones>
            <BotaoAcao title="Favoritar Game">{Icones.coracao}</BotaoAcao>
            <BotaoAcao title="Fechar Janela">{Icones.X}</BotaoAcao>
          </S.Icones>
        </FavoritarContainer>
        <img
      ...
      <S.PopUpDescription>
        ...
        <S.PopUpsText>
          ...
          <Paragrafo fontSize={16} marginBottom={24}>
            Você é Geralt de Rívia, mercenário matador de monstros. Você está em
            um continente devastado pela guerra e infestado de monstros para
            você explorar à vontade. Sua tarefa é encontrar Ciri, a Criança da
            Profecia — uma arma viva que pode alterar a forma do mundo.
          </Paragrafo>
        </S.PopUpsText>
        <S.InfosJogo>
          <S.Infos>
