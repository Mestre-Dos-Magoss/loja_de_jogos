...
const CardCompras = ({ size, description, id, image, name, newPrice, price, tag }:Props) => { // receberei as informações do produto e passarei por suas props
  const dispatch = useDispatch()
    ...
    <S.Produto size={size}>
        ...
        <InfosGame>
            ...
            <S.ExcluirProduto action={() => dispatch(remove({id}))} title='Excluir item' size={size}>
                {Icones.lixeira}
            </S.ExcluirProduto>
    </S.Produto>
  )
