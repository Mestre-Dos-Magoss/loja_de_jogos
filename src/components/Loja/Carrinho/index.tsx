...
import { CarrinhoHeader, CarrinhoProdutos, ButtonCarrinho, CarrinhoFooter } from '../../../styles'
    ...
    return (
        <S.CarrinhoContainer viewShopping={viewShopping}>
            <CarrinhoHeader>
                <S.CarrinhoLogo>
                    {Icones.sacola}
                    <P as="p" fontSize={16} >carrinho {quantidade}</P>
                </S.CarrinhoLogo>
                <div>
                    {Icones.X}
                </div>
            ...
            <CarrinhoFooter temProdutos={temProdutos}>
                <S.CarrinhoSubTotal>
                    ...
                    <P as="p" fontSize={16} >R$ {Preco}</P>
                </S.CarrinhoSubTotal>
                <ButtonCarrinho title='Ir para a área de pagamento' action={() => navigate('/pay')}>
                    <>
                        {Icones.cartao}
                        ir para o pagamento
                    </>
