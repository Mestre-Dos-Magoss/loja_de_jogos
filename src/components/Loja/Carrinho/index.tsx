...
import { PriceNovo, PriceAntigoo } from '../../../styles'
...
const Carrinho = () => (
    <S.CarrinhoContainer>
        ...
        <S.CarrinhoProdutos temProdutos>
            ...
            <S.CarrinhoComProduto className="CarrinhoComProdutos">
                ...
                <S.InfosGame className="infos_game">
                    <div>
        ...
        <S.CarrinhoFooter temProdutos>
            <S.CarrinhoSubTotal className="subTotal">
