...
import {
  ...
  ContainerPagamento as ContainerPagamentos,
...
const ContainerBoletoPIX = ({ tipoDePagamento }: Props) => {
  const msgButton =
    tipoDePagamento === enums.FormasDePagamento.BOLETO
      ? 'código de barras'
      : 'chave PIX'
      ...
      <ContainerPagamentos>
        ...
        <div>
          ...
          <S.ContainerPagamentoCodigo>
            {tipoDePagamento === enums.FormasDePagamento.PIX ? (
              <span>
                00020126580014br.gov.bcb.pix013662c4a0e1-4c8b-9d0e-8f5a4b3c2d1e5204000053039865802BR5925GAMESTORE
                LTDA6009SAO PAULO62070503***63044D3A
              </span>
            ) : (
        ...
        {tipoDePagamento === enums.FormasDePagamento.PIX ? (
          ...
          <S.MensagemBoleto>
            ...
            <span>
              23/01/2026 O boleto pode ser pago em qualquer banco, casa lotérica
              ou aplicativo bancário.
            </span>
          </S.MensagemBoleto>
        )}
      </ContainerPagamentos>
