...
const Carrousel = ({ Active }: Props) => {
  return (
    <S.Carrousel>
      <S.ArrowsContainer>
        <S.Arrow>{Icones.setaDireita}</S.Arrow>
        <S.Arrow>{Icones.setaEsquerda}</S.Arrow>
      </S.ArrowsContainer>
      ...
      <S.CarrouselDescription>
        <TagDesconto>-30% OFF</TagDesconto>
        <S.CarrouselTitle>Cyber Legends: Neon City</S.CarrouselTitle>
        <Paragrafo marginBottom={16} fontSize={16} tipo="Principal">
          Mergulhe em uma metrópole cyberpunk futurista repleta de aventuras e
          perigos. Escolha seu caminho em um mundo de tecnologia e conspiração.
        </Paragrafo>
        <Avaliations>
          <Avaliation>
            {Icones.estrela}
      ...
      <S.CarrouselImg
        src="https://cdn.loaded.com/media/catalog/product/c/o/co2228_7_.jpg"
        alt=""
      />
    </S.Carrousel>
  )
